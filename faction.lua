...
addCommandHandler("invite", function (thePlayer, command, player, faction, factionrank) -- /invite
...
addCommandHandler("listf", list_faction) -- /listf
...
addCommandHandler("cwar", clearwarn)

--============================================================================================================================
--============================================================================================================================

addCommandHandler("cwarns", function (thePlayer)
...
addCommandHandler("rankup", promote)

--=============================================================================================================================
--=============================================================================================================================

addCommandHandler("setfp", function (thePlayer, cmd, player, hfp, ...)
    if (Player_admin) < 14 then
        return false
    end
...
addCommandHandler("setfrank", setrank) -- command /setfrank
